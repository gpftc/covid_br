...
def plot_media_cases(data:dc,limit_period:int=0,color_line:str='red',
    ...
    ax = dados_bar.plot(x='index',y='casos_diarios',label=label_bar,kind='bar',color=color_bar)
...
label_line:str='',label_bar:str=''):
    ...
    ax = dados_bar.plot(x='index',y='mortes_diarias',label=label_bar,kind='bar',color=color_bar)
    date = dados_bar['date']
    plt.plot(date,media,label=label_line,c=color_line)
